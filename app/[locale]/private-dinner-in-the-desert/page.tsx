  ...
  content: [
    {
      ...
      title: "Tents and rooms available",
      desc: "",
    },
    {
      id: 2,
      imgSrc: "/assets/images/amenities-icon/walking.svg",
      title: "Board games and pool table",
      desc: "",
    },
    {
      id: 3,
...
const amenities = {
  title: "AMENITIES",
  desc: [
    "Desert Nights Camp offers luxury Arabian Desert adventures. It’s spread luxuriously across 10-acres of silken sands, secluded 11km within the vast isolation of the Omani desert.",
    "Highlights include a host of activities on the golden red sands of the Wahiba, topped by camel rides at sunset. Then feast on traditional Omani fare in the flickering glow of the campfire.",
    "The camp boasts 39 luxurious Bedouin-style tents, against the backdrop of spectacular craggy mountains in the distance, endless dunes and crystalline wadis. All rooms are air conditioned and feature lavish ensuite bathrooms."
  ]
};
...
const PrivateDinnerinTheDesert: React.FC<any> = ({ params: { locale } }) => {
...
export default PrivateDinnerinTheDesert;
